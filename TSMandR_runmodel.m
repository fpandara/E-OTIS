function TSMandR_runmodel(dx,dt,T,M,V,tin,A,As,D,alpha,Alg,RD,PD,figc,xrun,trun,filen,plott)
...
elseif figc==3
    nh3nin=M*1000/V;
    nh3nmat(1,1:tin)=(nh3nin*(V/tin)+RD.Value(10)*q*1000)/(q*1000+V/tin);%ammonia tracer input
elseif figc==4
    disspin=M*1000/V;
